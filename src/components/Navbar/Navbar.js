            ...
            <nav className="navbar navbar-expand-lg navbar-expand-md bg-dark pt-2 ">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ml-auto mt-2">
                        ...
                        <a class="btn resume-btn" href="https://drive.google.com/file/d/1BfgJrLU2an2iGUT6zj4t3VB_govt20fb/view?usp=sharing" role="button" rel="noreferrer" target="_blank"><strong>Resume</strong></a>
                    </ul>
                </div>
            </nav>
        </div>
